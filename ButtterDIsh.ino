...
//#define USE_SQL  //if we log data to a MySQL database

#ifndef D2
#define D2 13 //define D2 for one wire if it's not defined already
#endif // !D2
...
void setup()
{
  ...
  pinMode(LED_BUILTIN, OUTPUT); // Sets LED >> Output
